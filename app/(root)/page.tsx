  ...
  return (
    <>
      <main>
        ...
        <section className="px-4 lg:px-0">
          <div className="pt-[42px] lg:pt-[68px] flex flex-col items-center">
              <div className="flex flex-col items-center">
                ...
                <p className="pt-[6px] lg:w-[757px] text-center text-[24px] leading-[29px]">Let’s talk about my skills and experience in the digital marketing topics mentioned above starting with:</p>
              </div>
        ...
        There are many things considered in SEO, but here’s a brief overview of what I will forsee</p>
                </div>
                  ...
                  <div className="skill-display-container mt-[46px]">
                    ...
                    <div className="w-full">
                      <div className="pt-[46px]">
                        ...
                        <h4 className="pt-[9px] text-[24px] leading-[29px]">Google prioritizes both the quality and quantity of backlinks pointing to your website. <span className="font-bold">I can assist with the creation of backlinks through various working methods I am familiar with. Here’s a few:</span></h4>
                      </div>
