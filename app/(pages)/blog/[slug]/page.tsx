...
export async function generateStaticParams() {
    const res = await db.select({ slug: blogTable.slug }).from(blogTable);
    ...
    return (
        <main className="md:pt-[91px] md:max-w-6xl w-full md:mx-auto grid grid-cols-1 lg:grid-cols-3">
            <article className="md:pt-[64px] lg:col-span-2">
                <header>
                    <p className="md:text-[11.2px] text-[#954B00] font-bold uppercase tracking-[1.12px]">
                        {slug}
                    </p>
                    <h1 className="md:pt-4 md:text-[60px] md:leading-[60px] font-bold">
                    ...
                    <div className="mt-4 py-[21px] flex gap-7 items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[12px] leading-[18px] font-bold text-[#1A1A1A] ">
                                    Author Name
                                </p>
                                <p className="text-[12.8px] leading-[19.2px] text-[#666666] uppercase ">
                                    Lead Author
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <p className="text-[9.6px] leading-[14.4px] font-bold text-[#666666] uppercase ">
                                Published
                            </p>
                            <p className="text-[14.4px] leading-[21.6px] text-[#1A1A1A] ">
                                Date here
                            </p>
                        </div>
