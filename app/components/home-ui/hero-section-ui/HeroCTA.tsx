            ...
            <Modal showModal={showModal} onClose={() => setShowModal(false)}>
                <div className="m-auto py-10 w-[500px] h-fit px-8 bg-white rounded-3xl shadow-2xl">
                    <div className="flex justify-between gap-8">
                        <div>
                            <h2 className="text-[23px] leading-[28px] font-bold">
                                Get in touch
                            </h2>
                    ...
                    <div className="md:pt-4 flex flex-col md:gap-5">
                        <div className="p-5 h-fit flex justify-between items-center gap-5 border border-black/20 hover:border-indigo-600/50 rounded-md cursor-pointer transition-all group hover:bg-black/1">
                            <div className="w-12 h-12 flex justify-center items-center bg-[#0077b5] rounded-lg transition-all group-hover:scale-110">
                            ...
                            <div className="w-[80%]">
                                ...
                                <p className="text-[12px]">
                                    Connect on LinkedIn for quicker responses
                                </p>
                            </div>
                            <ChevronRight
                                size={18}
                        ...
                        <div className="p-5 h-fit flex justify-between items-center gap-5 border border-black/20 hover:border-indigo-600/50 rounded-md cursor-pointer transition-all group hover:bg-black/1">
                            <div className="w-12 h-12 flex justify-center items-center bg-[#00b558] rounded-lg transition-all group-hover:scale-110">
                            ...
                            <div className="w-[80%]">
                                ...
                                <p className="text-[12px]">
                                    Send me a text message on WhatsApp
                                </p>
                            </div>
                            <ChevronRight
                                size={18}
                        ...
                        <div className="p-5 h-fit flex justify-between items-center gap-5 border border-black/20 hover:border-indigo-600/50 rounded-md cursor-pointer transition-all group hover:bg-black/1">
                            <div className="w-12 h-12 flex justify-center items-center bg-[#b53900] rounded-lg transition-all group-hover:scale-110">
                                <Mail size={24} color="white" />
                            </div>
                            <div className="w-[80%]">
                                <h3 className="text-[16px] font-bold">Email</h3>
                                <p className="text-[12px]">
                                    Email me directly through Gmail or any other
                                    provider
                                </p>
                            </div>
                            <ChevronRight
                    ...
                    <h2 className="md:pt-10 text-center text-slate-500 text-sm font-medium">
                        Looking for something else?
                    </h2>
                    <div className="md:mt-2 flex justify-center">
                        <Link
                            href="/"
                            className="py-3 px-6 flex items-center gap-3 text-[14px] text-indigo-600 font-bold bg-indigo-50 rounded-lg"
                        >
                            <NotebookPen size={18} color="#4f39f6" /> Free SEO
                            Audit
                        </Link>
                    </div>
                </div>
