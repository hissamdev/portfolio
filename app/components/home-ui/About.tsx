...
export default function About() {
    return (
        <section className="pt-[119px] max-w-6xl mx-auto h-900">
            <div className="about-alignment flex justify-between">
                ...
                <div className="about-right relative z-10">
                    <div className="relative z-20 p-2.5 bg-white shadow-2xl rounded-[9px]">
                        <div className="relative z-30 w-[360px] h-[318px] rounded-[9px] overflow-hidden object-[70%_center] ">
                            <Image
                    ...
                    <div className="absolute -top-4 -left-2 w-[394px] h-[371px] -rotate-6 border-2 border-dashed border-[#BFBFBF]/40 z-0 rounded-2xl" />
                </div>
            </div>
        </section>
    )
