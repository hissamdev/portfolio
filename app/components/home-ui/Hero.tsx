            ...
            <section className="hero-section pt-[140px] h-900 bg-[#0b0e14]">
                <div className="px-[21px]">
                    <div>
                        ...
                        <h1 className="pt-[18px] text-white text-[31px] leading-[36px] font-bold">Full Stack Services <br />
                    ...
                    <div className="">
                        <div className="my-[28px] py-[21px] border-y border-gray-400/20">
                            <ul className="flex flex-col gap-4">
                                <li className="flex items-center gap-3">
                                    ...
                                    <p className="items-center text-[#64748b] text-[10.5px] leading-[14px] tracking-[1.575px] uppercase font-bold">Get more sales calls</p>
                                </li>
                                ...
                                <li className="flex items-center gap-3">
                                    ...
                                    <p className="items-center text-[#64748b] text-[10.5px] leading-[14px] tracking-[1.575px] uppercase font-bold">Sell more products</p>
                                </li>
                                ...
                                <li className="flex items-center gap-3">
                                    ...
                                    <p className="items-center text-[#64748b] text-[10.5px] leading-[14px] tracking-[1.575px] uppercase font-bold">Improve overall conversion rates</p>
                                </li>
                            </ul>
                        </div>
                    </div>
